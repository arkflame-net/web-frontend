...
export default function Home (props) {
    return (
        <div>
            <SummaryFullWide title="ArkFlame Network" subtitle="¡Bienvenido a nuestro Servidor! Disfruta en cualquiera de tus versiones favoritas (1.7.x - 1.17.x)">
                <Button width="100">play.arkflame.com</Button>
            </SummaryFullWide>

            <SummaryDoubles left={{ title: "Left", subtitle: "LOL" }} right={{ title:"Right", subtitle: "LOL but right side"}} />
            <SummaryTrio 
            ...
            <SummaryBigAndDoubles
                ...
                down={{ title:"DOWN", subtitle: "LOL but bottom side"}} 
            />
            <SummaryBigDoubles left={{ title: "Left", subtitle: "LOL" }} right={{ title:"Right", subtitle: "LOL but right side"}}/>
        </div>
    )
} 
